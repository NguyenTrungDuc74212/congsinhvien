            ...
            <div class="row">
              <div class="col-lg-6 ">
                <div class="image" style="text-align: center;">
                  <img src="{{ asset('public/images/logo_admin.jpg') }}" style="width: 100%; height: auto;">
              </div>
              </div>
                ...
                <div class="p-5" style="position: relative; top: 12%; height: 445px;">
                  ...
                  <form class="user" method="POST" action="{{ route('check_login') }}">
                    ...
                    <div class="form-group">
                      <input type="text" name="email" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="User Name ...">
                    </div>
                    <div class="form-group">
